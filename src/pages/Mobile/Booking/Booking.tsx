    ...
    return (
        <MobileContent>
            ...
            <DescriptionBody
                ...
                description={<div>We offer our Venues for a variety of events at an affordable price here in the Boston area. These halls are good for birthday parties, funeral receptions (repasts), weddings, or to host classes. We have two spacious halls that can accommodate up to 200-500 persons. Rentals include, tables, chairs, projectors, sound systems, and cleanup for the event. Upon request, catering and bartenders can be arranged.</div>}
            />
            <Carousel
                ...
                description='A versatile and elegant space to host any kind of event. Commonly utilized for birthday parties, a funeral receptions, weddings, or to host a class. This space features a stage, a open wide area, and a bar area upon the request for a bartender, while speakers are available for rent.'
            />
            <Carousel
